...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFFFA000);
  Color secondaryColor = const Color(0xFFFFA000);
  Color tertiaryColor = const Color(0xFFFFFFFF);
  Color alternate = const Color(0xFFF9F9F9);
  ...
  Color secondaryText = const Color(0xFF828A89);

  Color primaryBtnText = Color(0xFFFFA000);
  Color lineColor = Color(0xFF000000);
}
